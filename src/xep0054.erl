...
do_decode(<<"email">>, <<"vcard-temp">>, El, Opts) ->
    decode_vcard_emailid(<<"vcard-temp">>, Opts, El);
do_decode(<<"coverimg">>, <<"vcard-temp">>, El, Opts) ->
    decode_vcard_coverimg(<<"vcard-temp">>, Opts, El);
do_decode(<<"designation">>, <<"vcard-temp">>, El,
          Opts) ->
    decode_vcard_designation(<<"vcard-temp">>, Opts, El);
do_decode(<<"mobileNumber">>, <<"vcard-temp">>, El,
          Opts) ->
    decode_vcard_mobile_number(<<"vcard-temp">>, Opts, El);
do_decode(<<"image">>, <<"vcard-temp">>, El, Opts) ->
    decode_vcard_image(<<"vcard-temp">>, Opts, El);
do_decode(<<"status">>, <<"vcard-temp">>, El, Opts) ->
...
tags() ->
    [{<<"vCard">>, <<"vcard-temp">>},
     ...
     {<<"email">>, <<"vcard-temp">>},
     {<<"coverimg">>, <<"vcard-temp">>},
     {<<"designation">>, <<"vcard-temp">>},
     {<<"mobileNumber">>, <<"vcard-temp">>},
     {<<"image">>, <<"vcard-temp">>},
     {<<"status">>, <<"vcard-temp">>},
     {<<"ORG">>, <<"vcard-temp">>},
     {<<"PHOTO">>, <<"vcard-temp">>},
...
do_encode({vcard_status, _} = Status, TopXMLNS) ->
    encode_vcard_status(Status, TopXMLNS);
do_encode({vcard_image, _} = Image, TopXMLNS) ->
    encode_vcard_image(Image, TopXMLNS);
do_encode({vcard_mobile_number, _} = Mobilenumber,
          TopXMLNS) ->
    encode_vcard_mobile_number(Mobilenumber, TopXMLNS);
do_encode({vcard_designation, _} = Designation,
          TopXMLNS) ->
    encode_vcard_designation(Designation, TopXMLNS);
do_encode({vcard_coverimg, _} = Coverimg, TopXMLNS) ->
    encode_vcard_coverimg(Coverimg, TopXMLNS);
do_encode({vcard_emailid, _} = Email, TopXMLNS) ->
    encode_vcard_emailid(Email, TopXMLNS);
do_encode({vcard_nickName, _} = Nickname, TopXMLNS) ->
    encode_vcard_nickName(Nickname, TopXMLNS);
...
pp(vcard_status, 1) -> [vcard_status];
pp(vcard_image, 1) -> [vcard_image];
pp(vcard_mobile_number, 1) -> [vcard_mobile_number];
pp(vcard_designation, 1) -> [vcard_designation];
pp(vcard_coverimg, 1) -> [vcard_coverimg];
pp(vcard_emailid, 1) -> [vcard_email];
pp(vcard_nickName, 1) -> [vcard_nickName];
...
decode_vcard_temp_els(__TopXMLNS, __Opts, [], Mailer,
                      Vcard_mobile_number, Adr, Class, Categories, Desc,
                      Vcard_status, Uid, Prodid, Jabberid, Sound,
                      Vcard_emailid, Note, Role, Title, Nickname,
                      Vcard_nickName, Vcard_image, Rev, Sort_string,
                      Vcard_coverimg, Org, Bday, Key, Tz, Url, Email, Tel,
                      Label, Fn, Version, Vcard_designation, N, Photo, Logo,
                      Geo, __Els) ->
    {Mailer,
     Vcard_mobile_number,
     lists:reverse(Adr),
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"N">>, _attrs, _} = _el | _els], Mailer,
                      Vcard_mobile_number, Adr, Class, Categories, Desc,
                      Vcard_status, Uid, Prodid, Jabberid, Sound,
                      Vcard_emailid, Note, Role, Title, Nickname,
                      Vcard_nickName, Vcard_image, Rev, Sort_string,
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"status">>, _attrs, _} = _el | _els], Mailer,
                      Vcard_mobile_number, Adr, Class, Categories, Desc,
                      Vcard_status, Uid, Prodid, Jabberid, Sound,
                      Vcard_emailid, Note, Role, Title, Nickname,
                      Vcard_nickName, Vcard_image, Rev, Sort_string,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_temp_els(__TopXMLNS,
                                  ...
                                  Categories,
                                  Desc,
                                  decode_vcard_status(<<"vcard-temp">>,
                                                      __Opts,
                                                      _el),
                                  Uid,
                                  Prodid,
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      ...
                      Mailer, Vcard_mobile_number, Adr, Class, Categories,
                      Desc, Vcard_status, Uid, Prodid, Jabberid, Sound,
                      Vcard_emailid, Note, Role, Title, Nickname,
                      Vcard_nickName, Vcard_image, Rev, Sort_string,
                      Vcard_coverimg, Org, Bday, Key, Tz, Url, Email, Tel,
                      Label, Fn, Version, Vcard_designation, N, Photo, Logo,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_temp_els(__TopXMLNS,
                                  ...
                                  _els,
                                  Mailer,
                                  decode_vcard_mobile_number(<<"vcard-temp">>,
                                                             __Opts,
                                                             _el),
                                  Adr,
                                  Class,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_temp_els(__TopXMLNS,
                                  ...
                                  Fn,
                                  Version,
                                  decode_vcard_designation(<<"vcard-temp">>,
                                                           __Opts,
                                                           _el),
                                  N,
                                  Photo,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_temp_els(__TopXMLNS,
                                  ...
                                  Rev,
                                  Sort_string,
                                  decode_vcard_coverimg(<<"vcard-temp">>,
                                                        __Opts,
                                                        _el),
                                  Org,
                                  Bday,
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"image">>, _attrs, _} = _el | _els], Mailer,
                      Vcard_mobile_number, Adr, Class, Categories, Desc,
                      Vcard_status, Uid, Prodid, Jabberid, Sound,
                      Vcard_emailid, Note, Role, Title, Nickname,
                      Vcard_nickName, Vcard_image, Rev, Sort_string,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_temp_els(__TopXMLNS,
                                  ...
                                  Jabberid,
                                  Sound,
                                  decode_vcard_emailid(<<"vcard-temp">>,
                                                       __Opts,
                                                       _el),
                                  Note,
                                  Role,
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, _name, _attrs, _} = _el | _els], Mailer,
                      Vcard_mobile_number, Adr, Class, Categories, Desc,
                      Vcard_status, Uid, Prodid, Jabberid, Sound,
                      Vcard_emailid, Note, Role, Title, Nickname,
                      Vcard_nickName, Vcard_image, Rev, Sort_string,
    ...
    _els = [xmpp_codec:encode(_el, __NewTopXMLNS)
            || _el <- __Els]
               ...
               lists:reverse('encode_vcard_temp_$mailer'(Mailer,
                                                         __NewTopXMLNS,
                                                         'encode_vcard_temp_$vcard_mobile_number'(Vcard_mobile_number,
                                                                                                  __NewTopXMLNS,
                                                                                                                           ...
                                                                                                                           'encode_vcard_temp_$class'(Class,
                                                                                                                                                      ...
                                                                                                                                                      'encode_vcard_temp_$categories'(Categories,
                                                                                                                                                                                      ...
                                                                                                                                                                                      'encode_vcard_temp_$desc'(Desc,
                                                                                                                                                                                                                __NewTopXMLNS,
                                                                                                                                                                                                                'encode_vcard_temp_$vcard_status'(Vcard_status,
                                                                                                                                                                                                                                                  __NewTopXMLNS,
                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                           'encode_vcard_temp_$prodid'(Prodid,
                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                       'encode_vcard_temp_$jabberid'(Jabberid,
                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                     'encode_vcard_temp_$sound'(Sound,
                                                                                                                                                                                                                                                                                                                                                                __NewTopXMLNS,
                                                                                                                                                                                                                                                                                                                                                                'encode_vcard_temp_$vcard_emailid'(Vcard_emailid,
                                                                                                                                                                                                                                                                                                                                                                                                   __NewTopXMLNS,
                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                             'encode_vcard_temp_$role'(Role,
                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                       'encode_vcard_temp_$title'(Title,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  'encode_vcard_temp_$nickname'(Nickname,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                __NewTopXMLNS,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                'encode_vcard_temp_$vcard_nickName'(Vcard_nickName,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    __NewTopXMLNS,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    'encode_vcard_temp_$vcard_image'(Vcard_image,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     __NewTopXMLNS,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     'encode_vcard_temp_$rev'(Rev,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              __NewTopXMLNS,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              'encode_vcard_temp_$sort_string'(Sort_string,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               __NewTopXMLNS,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'encode_vcard_temp_$vcard_coverimg'(Vcard_coverimg,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   __NewTopXMLNS,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    'encode_vcard_temp_$label'(Label,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'encode_vcard_temp_$fn'(Fn,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       'encode_vcard_temp_$version'(Version,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    __NewTopXMLNS,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    'encode_vcard_temp_$vcard_designation'(Vcard_designation,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           __NewTopXMLNS,
...
'encode_vcard_temp_$vcard_mobile_number'(undefined,
                                         __TopXMLNS, _acc) ->
    _acc;
'encode_vcard_temp_$vcard_mobile_number'(Vcard_mobile_number,
                                         __TopXMLNS, _acc) ->
    [encode_vcard_mobile_number(Vcard_mobile_number,
                                __TopXMLNS)
     | _acc].
...
'encode_vcard_temp_$vcard_status'(undefined, __TopXMLNS,
                                  _acc) ->
    _acc;
'encode_vcard_temp_$vcard_status'(Vcard_status,
                                  __TopXMLNS, _acc) ->
    [encode_vcard_status(Vcard_status, __TopXMLNS) | _acc].
...
'encode_vcard_temp_$vcard_emailid'(undefined,
                                   __TopXMLNS, _acc) ->
    _acc;
'encode_vcard_temp_$vcard_emailid'(Vcard_emailid,
                                   __TopXMLNS, _acc) ->
    [encode_vcard_emailid(Vcard_emailid, __TopXMLNS)
     | _acc].
...
'encode_vcard_temp_$vcard_nickName'(undefined,
                                    __TopXMLNS, _acc) ->
    _acc;
'encode_vcard_temp_$vcard_nickName'(Vcard_nickName,
                                    __TopXMLNS, _acc) ->
    [encode_vcard_nickName(Vcard_nickName, __TopXMLNS)
     | _acc].

'encode_vcard_temp_$vcard_image'(undefined, __TopXMLNS,
                                 _acc) ->
    _acc;
'encode_vcard_temp_$vcard_image'(Vcard_image,
                                 __TopXMLNS, _acc) ->
    [encode_vcard_image(Vcard_image, __TopXMLNS) | _acc].
...
'encode_vcard_temp_$vcard_coverimg'(undefined,
                                    __TopXMLNS, _acc) ->
    _acc;
'encode_vcard_temp_$vcard_coverimg'(Vcard_coverimg,
                                    __TopXMLNS, _acc) ->
    [encode_vcard_coverimg(Vcard_coverimg, __TopXMLNS)
     | _acc].
...
'encode_vcard_temp_$vcard_designation'(undefined,
                                       __TopXMLNS, _acc) ->
    _acc;
'encode_vcard_temp_$vcard_designation'(Vcard_designation,
                                       __TopXMLNS, _acc) ->
    [encode_vcard_designation(Vcard_designation, __TopXMLNS)
     | _acc].
...
decode_vcard_CLASS(__TopXMLNS, __Opts,
    ...
    Class = decode_vcard_CLASS_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   undefined),
    Class.
...
encode_vcard_SOUND({vcard_sound,
                    Phonetic,
                    Binval,
                    Extval},
                   __TopXMLNS) ->
...
decode_vcard_nickName(__TopXMLNS, __Opts,
    ...
    Vcard_nickName = decode_vcard_nickName_els(__TopXMLNS,
                                               __Opts,
                                               _els,
                                               <<>>),
    {vcard_nickName, Vcard_nickName}.

decode_vcard_nickName_els(__TopXMLNS, __Opts, [],
                          Vcard_nickName) ->
    decode_vcard_nickName_cdata(__TopXMLNS, Vcard_nickName);
decode_vcard_nickName_els(__TopXMLNS, __Opts,
                          [{xmlcdata, _data} | _els], Vcard_nickName) ->
    decode_vcard_nickName_els(__TopXMLNS,
                              __Opts,
                              _els,
                              <<Vcard_nickName/binary, _data/binary>>);
decode_vcard_nickName_els(__TopXMLNS, __Opts,
                          [_ | _els], Vcard_nickName) ->
    decode_vcard_nickName_els(__TopXMLNS,
                              __Opts,
                              _els,
                              Vcard_nickName).

encode_vcard_nickName({vcard_nickName, Vcard_nickName},
                      __TopXMLNS) ->
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    [],
                                    __TopXMLNS),
    _els = encode_vcard_nickName_cdata(Vcard_nickName, []),
    _attrs = xmpp_codec:enc_xmlns_attrs(__NewTopXMLNS,
                                        __TopXMLNS),
    {xmlel, <<"nickName">>, _attrs, _els}.
...
decode_vcard_emailid(__TopXMLNS, __Opts,
                     {xmlel, <<"email">>, _attrs, _els}) ->
    Vcard_email = decode_vcard_emailid_els(__TopXMLNS,
                                           __Opts,
                                           _els,
                                           <<>>),
    {vcard_emailid, Vcard_email}.

decode_vcard_emailid_els(__TopXMLNS, __Opts, [],
                         Vcard_email) ->
    decode_vcard_emailid_cdata(__TopXMLNS, Vcard_email);
decode_vcard_emailid_els(__TopXMLNS, __Opts,
                         [{xmlcdata, _data} | _els], Vcard_email) ->
    decode_vcard_emailid_els(__TopXMLNS,
                             __Opts,
                             _els,
                             <<Vcard_email/binary, _data/binary>>);
decode_vcard_emailid_els(__TopXMLNS, __Opts, [_ | _els],
                         Vcard_email) ->
    decode_vcard_emailid_els(__TopXMLNS,
                             __Opts,
                             _els,
...
encode_vcard_emailid({vcard_emailid, Vcard_email},
                     __TopXMLNS) ->
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    [],
                                    __TopXMLNS),
    _els = encode_vcard_emailid_cdata(Vcard_email, []),
    _attrs = xmpp_codec:enc_xmlns_attrs(__NewTopXMLNS,
                                        __TopXMLNS),
    {xmlel, <<"email">>, _attrs, _els}.

decode_vcard_emailid_cdata(__TopXMLNS, <<>>) -> <<>>;
decode_vcard_emailid_cdata(__TopXMLNS, _val) -> _val.

encode_vcard_emailid_cdata(<<>>, _acc) -> _acc;
encode_vcard_emailid_cdata(_val, _acc) ->
    [{xmlcdata, _val} | _acc].

decode_vcard_coverimg(__TopXMLNS, __Opts,
                      {xmlel, <<"coverimg">>, _attrs, _els}) ->
    Vcard_coverimg = decode_vcard_coverimg_els(__TopXMLNS,
                                               __Opts,
                                               _els,
                                               <<>>),
    {vcard_coverimg, Vcard_coverimg}.

decode_vcard_coverimg_els(__TopXMLNS, __Opts, [],
                          Vcard_coverimg) ->
    decode_vcard_coverimg_cdata(__TopXMLNS, Vcard_coverimg);
decode_vcard_coverimg_els(__TopXMLNS, __Opts,
                          [{xmlcdata, _data} | _els], Vcard_coverimg) ->
    decode_vcard_coverimg_els(__TopXMLNS,
                              __Opts,
                              _els,
                              <<Vcard_coverimg/binary, _data/binary>>);
decode_vcard_coverimg_els(__TopXMLNS, __Opts,
                          [_ | _els], Vcard_coverimg) ->
    decode_vcard_coverimg_els(__TopXMLNS,
                              __Opts,
                              _els,
                              Vcard_coverimg).

encode_vcard_coverimg({vcard_coverimg, Vcard_coverimg},
                      __TopXMLNS) ->
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    [],
                                    __TopXMLNS),
    _els = encode_vcard_coverimg_cdata(Vcard_coverimg, []),
    _attrs = xmpp_codec:enc_xmlns_attrs(__NewTopXMLNS,
                                        __TopXMLNS),
    {xmlel, <<"coverimg">>, _attrs, _els}.

decode_vcard_coverimg_cdata(__TopXMLNS, <<>>) -> <<>>;
decode_vcard_coverimg_cdata(__TopXMLNS, _val) -> _val.

encode_vcard_coverimg_cdata(<<>>, _acc) -> _acc;
encode_vcard_coverimg_cdata(_val, _acc) ->
    [{xmlcdata, _val} | _acc].

decode_vcard_designation(__TopXMLNS, __Opts,
                         {xmlel, <<"designation">>, _attrs, _els}) ->
    Vcard_designation =
        decode_vcard_designation_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     <<>>),
    {vcard_designation, Vcard_designation}.

decode_vcard_designation_els(__TopXMLNS, __Opts, [],
                             Vcard_designation) ->
    decode_vcard_designation_cdata(__TopXMLNS,
                                   Vcard_designation);
decode_vcard_designation_els(__TopXMLNS, __Opts,
                             [{xmlcdata, _data} | _els], Vcard_designation) ->
    decode_vcard_designation_els(__TopXMLNS,
                                 __Opts,
                                 _els,
                                 <<Vcard_designation/binary, _data/binary>>);
decode_vcard_designation_els(__TopXMLNS, __Opts,
                             [_ | _els], Vcard_designation) ->
    decode_vcard_designation_els(__TopXMLNS,
                                 __Opts,
                                 _els,
                                 Vcard_designation).

encode_vcard_designation({vcard_designation,
                          Vcard_designation},
                         __TopXMLNS) ->
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    [],
                                    __TopXMLNS),
    _els = encode_vcard_designation_cdata(Vcard_designation,
                                          []),
    _attrs = xmpp_codec:enc_xmlns_attrs(__NewTopXMLNS,
                                        __TopXMLNS),
    {xmlel, <<"designation">>, _attrs, _els}.
...
decode_vcard_designation_cdata(__TopXMLNS, <<>>) ->
    <<>>;
decode_vcard_designation_cdata(__TopXMLNS, _val) ->
    _val.

encode_vcard_designation_cdata(<<>>, _acc) -> _acc;
encode_vcard_designation_cdata(_val, _acc) ->
    [{xmlcdata, _val} | _acc].

decode_vcard_mobile_number(__TopXMLNS, __Opts,
                           {xmlel, <<"mobileNumber">>, _attrs, _els}) ->
    Vcard_mobile_number =
        decode_vcard_mobile_number_els(__TopXMLNS,
                                       __Opts,
                                       _els,
                                       <<>>),
    {vcard_mobile_number, Vcard_mobile_number}.

decode_vcard_mobile_number_els(__TopXMLNS, __Opts, [],
                               Vcard_mobile_number) ->
    decode_vcard_mobile_number_cdata(__TopXMLNS,
                                     Vcard_mobile_number);
decode_vcard_mobile_number_els(__TopXMLNS, __Opts,
                               [{xmlcdata, _data} | _els],
                               Vcard_mobile_number) ->
    decode_vcard_mobile_number_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<Vcard_mobile_number/binary,
                                     _data/binary>>);
decode_vcard_mobile_number_els(__TopXMLNS, __Opts,
                               [_ | _els], Vcard_mobile_number) ->
    decode_vcard_mobile_number_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   Vcard_mobile_number).
...
encode_vcard_mobile_number({vcard_mobile_number,
    ...
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    ...
                                    __TopXMLNS),
    _els =
        encode_vcard_mobile_number_cdata(Vcard_mobile_number,
                                         []),
    _attrs = xmpp_codec:enc_xmlns_attrs(__NewTopXMLNS,
                                        __TopXMLNS),
    {xmlel, <<"mobileNumber">>, _attrs, _els}.
...
decode_vcard_mobile_number_cdata(__TopXMLNS, <<>>) ->
    <<>>;
decode_vcard_mobile_number_cdata(__TopXMLNS, _val) ->
    _val.

encode_vcard_mobile_number_cdata(<<>>, _acc) -> _acc;
encode_vcard_mobile_number_cdata(_val, _acc) ->
    [{xmlcdata, _val} | _acc].

decode_vcard_image(__TopXMLNS, __Opts,
                   {xmlel, <<"image">>, _attrs, _els}) ->
    Vcard_image = decode_vcard_image_els(__TopXMLNS,
                                         __Opts,
                                         _els,
                                         <<>>),
    {vcard_image, Vcard_image}.

decode_vcard_image_els(__TopXMLNS, __Opts, [],
                       Vcard_image) ->
    decode_vcard_image_cdata(__TopXMLNS, Vcard_image);
decode_vcard_image_els(__TopXMLNS, __Opts,
                       [{xmlcdata, _data} | _els], Vcard_image) ->
    decode_vcard_image_els(__TopXMLNS,
                           __Opts,
                           _els,
                           <<Vcard_image/binary, _data/binary>>);
decode_vcard_image_els(__TopXMLNS, __Opts, [_ | _els],
                       Vcard_image) ->
    decode_vcard_image_els(__TopXMLNS,
                           __Opts,
                           _els,
...
encode_vcard_image({vcard_image, Vcard_image},
                   __TopXMLNS) ->
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    [],
                                    __TopXMLNS),
    _els = encode_vcard_image_cdata(Vcard_image, []),
    _attrs = xmpp_codec:enc_xmlns_attrs(__NewTopXMLNS,
                                        __TopXMLNS),
    {xmlel, <<"image">>, _attrs, _els}.

decode_vcard_image_cdata(__TopXMLNS, <<>>) -> <<>>;
decode_vcard_image_cdata(__TopXMLNS, _val) -> _val.

encode_vcard_image_cdata(<<>>, _acc) -> _acc;
encode_vcard_image_cdata(_val, _acc) ->
    [{xmlcdata, _val} | _acc].

decode_vcard_status(__TopXMLNS, __Opts,
                    {xmlel, <<"status">>, _attrs, _els}) ->
    Vcard_status = decode_vcard_status_els(__TopXMLNS,
                                           __Opts,
                                           _els,
                                           <<>>),
...
decode_vcard_status_els(__TopXMLNS, __Opts, [],
                        Vcard_status) ->
    decode_vcard_status_cdata(__TopXMLNS, Vcard_status);
decode_vcard_status_els(__TopXMLNS, __Opts,
                        [{xmlcdata, _data} | _els], Vcard_status) ->
    decode_vcard_status_els(__TopXMLNS,
                            __Opts,
                            _els,
                            <<Vcard_status/binary, _data/binary>>);
...
encode_vcard_status({vcard_status, Vcard_status},
                    __TopXMLNS) ->
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    [],
                                    __TopXMLNS),
    _els = encode_vcard_status_cdata(Vcard_status, []),
    _attrs = xmpp_codec:enc_xmlns_attrs(__NewTopXMLNS,
                                        __TopXMLNS),
    {xmlel, <<"status">>, _attrs, _els}.
...
decode_vcard_BINVAL(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_BINVAL_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
encode_vcard_EMAIL({vcard_email,
                    Home,
                    Work,
                    Internet,
                    Pref,
...
encode_vcard_LABEL({vcard_label,
                    Home,
                    Work,
                    Postal,
                    Parcel,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_N_els(__TopXMLNS,
                               ...
                               Suffix,
                               Prefix,
                               decode_vcard_FAMILY(<<"vcard-temp">>,
                                                   __Opts,
                                                   _el),
                               Given);
        _ ->
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_N_els(__TopXMLNS,
                               __Opts,
                               _els,
                               decode_vcard_MIDDLE(<<"vcard-temp">>,
                                                   __Opts,
                                                   _el),
                               Suffix,
                               Prefix,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_N_els(__TopXMLNS,
                               ...
                               Middle,
                               Suffix,
                               decode_vcard_PREFIX(<<"vcard-temp">>,
                                                   __Opts,
                                                   _el),
                               Family,
                               Given);
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        <<"vcard-temp">> ->
            decode_vcard_N_els(__TopXMLNS,
                               ...
                               _els,
                               Middle,
                               decode_vcard_SUFFIX(<<"vcard-temp">>,
                                                   __Opts,
                                                   _el),
                               Prefix,
                               Family,
...
decode_vcard_EXTVAL(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_EXTVAL_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_TYPE(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_TYPE_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<>>),
    Cdata.
...
decode_vcard_DESC(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_DESC_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<>>),
    Cdata.
...
decode_vcard_URL(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_URL_els(__TopXMLNS,
                                 __Opts,
                                 _els,
                                 <<>>),
    Cdata.
...
decode_vcard_UID(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_UID_els(__TopXMLNS,
                                 __Opts,
                                 _els,
                                 <<>>),
    Cdata.
...
decode_vcard_REV(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_REV_els(__TopXMLNS,
                                 __Opts,
                                 _els,
                                 <<>>),
    Cdata.
...
decode_vcard_PRODID(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_PRODID_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_NOTE(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_NOTE_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<>>),
    Cdata.
...
decode_vcard_ROLE(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_ROLE_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<>>),
    Cdata.
...
decode_vcard_TITLE(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_TITLE_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<>>),
    Cdata.
...
decode_vcard_TZ(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_TZ_els(__TopXMLNS,
                                __Opts,
                                _els,
                                <<>>),
    Cdata.
...
decode_vcard_MAILER(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_MAILER_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_BDAY(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_BDAY_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<>>),
    Cdata.
...
decode_vcard_FN(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_FN_els(__TopXMLNS,
                                __Opts,
                                _els,
                                <<>>),
    Cdata.
...
decode_vcard_CRED(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_CRED_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<>>),
    Cdata.
...
decode_vcard_LON(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_LON_els(__TopXMLNS,
                                 __Opts,
                                 _els,
                                 <<>>),
    Cdata.
...
decode_vcard_LAT(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_LAT_els(__TopXMLNS,
                                 __Opts,
                                 _els,
                                 <<>>),
    Cdata.
...
decode_vcard_USERID(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_USERID_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_NUMBER(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_NUMBER_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_LINE(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_LINE_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<>>),
    Cdata.
...
decode_vcard_CTRY(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_CTRY_els(__TopXMLNS,
                                  __Opts,
                                  _els,
                                  <<>>),
    Cdata.
...
decode_vcard_PCODE(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_PCODE_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<>>),
    Cdata.
...
decode_vcard_REGION(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_REGION_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_STREET(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_STREET_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_EXTADD(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_EXTADD_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_POBOX(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_POBOX_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<>>),
    Cdata.
...
decode_vcard_SUFFIX(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_SUFFIX_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_PREFIX(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_PREFIX_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_MIDDLE(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_MIDDLE_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_vcard_GIVEN(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_GIVEN_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<>>),
    Cdata.
...
decode_vcard_FAMILY(__TopXMLNS, __Opts,
    ...
    Cdata = decode_vcard_FAMILY_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
