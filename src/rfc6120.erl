...
encode_stream_start({stream_start,
                     From,
                     To,
                     Id,
                     Version,
...
'encode_stream_error_$text'([Text | _els], __TopXMLNS,
                            _acc) ->
    'encode_stream_error_$text'(_els,
                                __TopXMLNS,
...
decode_starttls(__TopXMLNS, __Opts,
    ...
    Required = decode_starttls_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   false),
    {starttls, Required}.
...
decode_sasl_success(__TopXMLNS, __Opts,
    ...
    Text = decode_sasl_success_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<>>),
    {sasl_success, Text}.
...
decode_sasl_response(__TopXMLNS, __Opts,
    ...
    Text = decode_sasl_response_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    {sasl_response, Text}.
...
decode_sasl_auth(__TopXMLNS, __Opts,
    ...
    Text = decode_sasl_auth_els(__TopXMLNS,
                                __Opts,
                                _els,
                                <<>>),
    Mechanism = decode_sasl_auth_attrs(__TopXMLNS,
                                       _attrs,
                                       undefined),
...
decode_bind_jid(__TopXMLNS, __Opts,
    ...
    Cdata = decode_bind_jid_els(__TopXMLNS,
                                __Opts,
                                _els,
                                <<>>),
    Cdata.
...
decode_error_text(__TopXMLNS, __Opts,
                  {xmlel, <<"text">>, _attrs, _els}) ->
    Data = decode_error_text_els(__TopXMLNS,
                                 __Opts,
                                 _els,
                                 <<>>),
    Lang = decode_error_text_attrs(__TopXMLNS,
                                   _attrs,
                                   undefined),
    {text, Lang, Data}.
...
decode_error_redirect(__TopXMLNS, __Opts,
    ...
    Uri = decode_error_redirect_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    {redirect, Uri}.
...
decode_error_gone(__TopXMLNS, __Opts,
    ...
    Uri = decode_error_gone_els(__TopXMLNS,
                                __Opts,
                                _els,
                                <<>>),
    {gone, Uri}.
...
decode_presence_status(__TopXMLNS, __Opts,
    ...
    Data = decode_presence_status_els(__TopXMLNS,
                                      ...
                                      _els,
                                      <<>>),
    Lang = decode_presence_status_attrs(__TopXMLNS,
                                        _attrs,
                                        undefined),
    {text, Lang, Data}.
...
decode_message_thread(__TopXMLNS, __Opts,
    ...
    Data = decode_message_thread_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     <<>>),
    Parent = decode_message_thread_attrs(__TopXMLNS,
                                         _attrs,
                                         undefined),
...
decode_message_body(__TopXMLNS, __Opts,
    ...
    Data = decode_message_body_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<>>),
    Lang = decode_message_body_attrs(__TopXMLNS,
                                     _attrs,
                                     undefined),
    {text, Lang, Data}.
...
decode_message_subject(__TopXMLNS, __Opts,
    ...
    Data = decode_message_subject_els(__TopXMLNS,
                                      ...
                                      _els,
                                      <<>>),
    Lang = decode_message_subject_attrs(__TopXMLNS,
                                        _attrs,
                                        undefined),
    {text, Lang, Data}.
