...
do_get_name({mix_join, _, _, _, _, _, _, _, _, _}) ->
    <<"join">>;
do_get_name({mix_leave, _}) -> <<"leave">>;
do_get_name({mix_participant, _, _, _, _, _, _}) ->
    <<"participant">>;
...
do_get_ns({mix_join, _, _, _, _, Xmlns, _, _, _, _}) ->
    Xmlns;
do_get_ns({mix_leave, Xmlns}) -> Xmlns;
do_get_ns({mix_participant, _, _, Xmlns, _, _, _}) ->
    Xmlns;
...
pp(mix_participant, 6) ->
    [jid, nick, xmlns, usernick, sendernick, request_type];
...
decode_mix_participant(__TopXMLNS, __Opts,
    ...
    {Jid, Nick, Xmlns, Sendernick, Request_type, Usernick} =
...
decode_mix_participant_attrs(__TopXMLNS,
                             ...
                             Sendernick, Request_type, Usernick) ->
    decode_mix_participant_attrs(__TopXMLNS,
                                 _attrs,
                                 _val,
                                 Nick,
                                 ...
                                 Usernick);
decode_mix_participant_attrs(__TopXMLNS,
                             [{<<"nick">>, _val} | _attrs], Jid, _Nick, Xmlns,
                             Sendernick, Request_type, Usernick) ->
    decode_mix_participant_attrs(__TopXMLNS,
                                 _attrs,
                                 Jid,
                                 ...
                                 Usernick);
decode_mix_participant_attrs(__TopXMLNS,
                             [{<<"xmlns">>, _val} | _attrs], Jid, Nick, _Xmlns,
                             Sendernick, Request_type, Usernick) ->
    decode_mix_participant_attrs(__TopXMLNS,
                                 _attrs,
                                 Jid,
                                 ...
                                 Usernick);
decode_mix_participant_attrs(__TopXMLNS,
                             [{<<"sendernick">>, _val} | _attrs], Jid, Nick,
                             Xmlns, _Sendernick, Request_type, Usernick) ->
    decode_mix_participant_attrs(__TopXMLNS,
                                 _attrs,
                                 Jid,
                                 Nick,
                                 ...
                                 Usernick);
decode_mix_participant_attrs(__TopXMLNS,
                             [{<<"request_type">>, _val} | _attrs], Jid, Nick,
                             Xmlns, Sendernick, _Request_type, Usernick) ->
    decode_mix_participant_attrs(__TopXMLNS,
                                 _attrs,
                                 Jid,
                                 Nick,
                                 ...
                                 Usernick);
decode_mix_participant_attrs(__TopXMLNS,
                             [{<<"usernick">>, _val} | _attrs], Jid, Nick,
                             Xmlns, Sendernick, Request_type, _Usernick) ->
    decode_mix_participant_attrs(__TopXMLNS,
                                 _attrs,
                                 Jid,
                                 Nick,
...
decode_mix_participant_attrs(__TopXMLNS, [_ | _attrs],
                             Jid, Nick, Xmlns, Sendernick, Request_type,
                             Usernick) ->
    decode_mix_participant_attrs(__TopXMLNS,
                                 _attrs,
                                 Jid,
...
decode_mix_participant_attrs(__TopXMLNS, [], Jid, Nick,
                             Xmlns, Sendernick, Request_type, Usernick) ->
    {decode_mix_participant_attr_jid(__TopXMLNS, Jid),
     ...
     decode_mix_participant_attr_sendernick(__TopXMLNS,
                                            Sendernick),
     decode_mix_participant_attr_request_type(__TopXMLNS,
                                              Request_type),
     decode_mix_participant_attr_usernick(__TopXMLNS,
                                          Usernick)}.
...
encode_mix_participant({mix_participant,
    ...
    __NewTopXMLNS = xmpp_codec:choose_top_xmlns(Xmlns,
                                                ...
                                                __TopXMLNS),
    _els = [],
    _attrs = encode_mix_participant_attr_usernick(Usernick,
                                                  encode_mix_participant_attr_request_type(Request_type,
                                                                                           encode_mix_participant_attr_sendernick(Sendernick,
                                                                                                                                  encode_mix_participant_attr_nick(Nick,
...
encode_mix_participant_attr_sendernick(<<>>, _acc) ->
    _acc;
encode_mix_participant_attr_sendernick(_val, _acc) ->
...
encode_mix_participant_attr_request_type(<<>>, _acc) ->
    _acc;
encode_mix_participant_attr_request_type(_val, _acc) ->
    [{<<"request_type">>, _val} | _acc].
...
encode_mix_participant_attr_usernick(<<>>, _acc) ->
    _acc;
encode_mix_participant_attr_usernick(_val, _acc) ->
    [{<<"usernick">>, _val} | _acc].
...
decode_mix_join_attrs(__TopXMLNS,
                      [{<<"id">>, _val} | _attrs], _Id, Jid, Xmlns, Owner,
                      Usernick, Sendernick, Request_type) ->
    decode_mix_join_attrs(__TopXMLNS,
                          _attrs,
                          _val,
                          Jid,
                          ...
                          Request_type);
decode_mix_join_attrs(__TopXMLNS,
                      [{<<"jid">>, _val} | _attrs], Id, _Jid, Xmlns, Owner,
                      Usernick, Sendernick, Request_type) ->
    decode_mix_join_attrs(__TopXMLNS,
                          _attrs,
                          Id,
                          ...
                          Request_type);
decode_mix_join_attrs(__TopXMLNS,
                      [{<<"xmlns">>, _val} | _attrs], Id, Jid, _Xmlns, Owner,
                      Usernick, Sendernick, Request_type) ->
    decode_mix_join_attrs(__TopXMLNS,
                          _attrs,
                          Id,
                          ...
                          Request_type);
decode_mix_join_attrs(__TopXMLNS,
                      [{<<"owner">>, _val} | _attrs], Id, Jid, Xmlns, _Owner,
                      Usernick, Sendernick, Request_type) ->
    decode_mix_join_attrs(__TopXMLNS,
                          _attrs,
                          Id,
                          ...
                          Request_type);
decode_mix_join_attrs(__TopXMLNS,
                      [{<<"usernick">>, _val} | _attrs], Id, Jid, Xmlns,
                      Owner, _Usernick, Sendernick, Request_type) ->
    decode_mix_join_attrs(__TopXMLNS,
                          _attrs,
                          Id,
                          Jid,
                          ...
                          Request_type);
decode_mix_join_attrs(__TopXMLNS,
                      [{<<"sendernick">>, _val} | _attrs], Id, Jid, Xmlns,
                      Owner, Usernick, _Sendernick, Request_type) ->
    decode_mix_join_attrs(__TopXMLNS,
                          _attrs,
                          Id,
                          Jid,
                          ...
                          Request_type);
decode_mix_join_attrs(__TopXMLNS,
                      [{<<"request_type">>, _val} | _attrs], Id, Jid, Xmlns,
                      Owner, Usernick, Sendernick, _Request_type) ->
    decode_mix_join_attrs(__TopXMLNS,
                          _attrs,
                          Id,
                          Jid,
...
decode_mix_join_attrs(__TopXMLNS, [_ | _attrs], Id, Jid,
                      Xmlns, Owner, Usernick, Sendernick, Request_type) ->
    decode_mix_join_attrs(__TopXMLNS,
                          _attrs,
                          Id,
                          Jid,
...
decode_mix_join_attrs(__TopXMLNS, [], Id, Jid, Xmlns,
                      Owner, Usernick, Sendernick, Request_type) ->
    {decode_mix_join_attr_id(__TopXMLNS, Id),
     decode_mix_join_attr_jid(__TopXMLNS, Jid),
     decode_mix_join_attr_xmlns(__TopXMLNS, Xmlns),
     decode_mix_join_attr_owner(__TopXMLNS, Owner),
     decode_mix_join_attr_usernick(__TopXMLNS, Usernick),
     decode_mix_join_attr_sendernick(__TopXMLNS, Sendernick),
     decode_mix_join_attr_request_type(__TopXMLNS,
                                       Request_type)}.
    ...
    _els =
        lists:reverse('encode_mix_join_$subscribe'(Subscribe,
                                                   ...
                                                   'encode_mix_join_$nick'(Nick,
                                                                           __NewTopXMLNS,
                                                                           []))),
    _attrs = encode_mix_join_attr_request_type(Request_type,
                                               encode_mix_join_attr_sendernick(Sendernick,
                                                                               encode_mix_join_attr_usernick(Usernick,
                                                                                                             encode_mix_join_attr_owner(Owner,
                                                                                                                                        encode_mix_join_attr_jid(Jid,
...
decode_mix_join_attr_owner(__TopXMLNS, undefined) ->
    <<>>;
decode_mix_join_attr_owner(__TopXMLNS, _val) -> _val.

encode_mix_join_attr_owner(<<>>, _acc) -> _acc;
encode_mix_join_attr_owner(_val, _acc) ->
    [{<<"owner">>, _val} | _acc].

decode_mix_join_attr_usernick(__TopXMLNS, undefined) ->
    <<>>;
decode_mix_join_attr_usernick(__TopXMLNS, _val) -> _val.

encode_mix_join_attr_usernick(<<>>, _acc) -> _acc;
encode_mix_join_attr_usernick(_val, _acc) ->
    [{<<"usernick">>, _val} | _acc].

decode_mix_join_attr_sendernick(__TopXMLNS,
                                undefined) ->
    <<>>;
decode_mix_join_attr_sendernick(__TopXMLNS, _val) ->
    _val.

encode_mix_join_attr_sendernick(<<>>, _acc) -> _acc;
encode_mix_join_attr_sendernick(_val, _acc) ->
    [{<<"sendernick">>, _val} | _acc].

decode_mix_join_attr_request_type(__TopXMLNS,
                                  undefined) ->
    <<>>;
decode_mix_join_attr_request_type(__TopXMLNS, _val) ->
    _val.

encode_mix_join_attr_request_type(<<>>, _acc) -> _acc;
encode_mix_join_attr_request_type(_val, _acc) ->
    [{<<"request_type">>, _val} | _acc].
