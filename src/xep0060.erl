...
encode_pubsub_error_unsupported({ps_error,
                                 unsupported,
                                 Feature},
                                __TopXMLNS) ->
    __NewTopXMLNS =
...
decode_pubsub_purge(__TopXMLNS, __Opts,
    ...
    Node = decode_pubsub_purge_attrs(__TopXMLNS,
                                     _attrs,
                                     undefined),
    Node.
...
decode_pubsub_delete(__TopXMLNS, __Opts,
    ...
    Uri = decode_pubsub_delete_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   <<>>),
    Node = decode_pubsub_delete_attrs(__TopXMLNS,
                                      _attrs,
                                      undefined),
    {Node, Uri}.
...
decode_pubsub_delete_els(__TopXMLNS, __Opts,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        of
        <<"http://jabber.org/protocol/pubsub">> ->
            decode_pubsub_delete_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     decode_pubsub_redirect(<<"http://jabber.org/protocol/pubsub">>,
                                                            __Opts,
...
decode_pubsub_redirect(__TopXMLNS, __Opts,
    ...
    Uri = decode_pubsub_redirect_attrs(__TopXMLNS,
                                       _attrs,
                                       undefined),
    Uri.
...
decode_pubsub_default(__TopXMLNS, __Opts,
    ...
    Xdata = decode_pubsub_default_els(__TopXMLNS,
                                      ...
                                      _els,
                                      undefined),
    Node = decode_pubsub_default_attrs(__TopXMLNS,
                                       _attrs,
                                       undefined),
    {Node, Xdata}.
...
decode_pubsub_default_els(__TopXMLNS, __Opts,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        of
        <<"jabber:x:data">> ->
            decode_pubsub_default_els(__TopXMLNS,
                                      __Opts,
                                      _els,
...
decode_pubsub_configure(__TopXMLNS, __Opts,
    ...
    Xdata = decode_pubsub_configure_els(__TopXMLNS,
                                        ...
                                        _els,
                                        undefined),
    Node = decode_pubsub_configure_attrs(__TopXMLNS,
                                         _attrs,
                                         undefined),
    {Node, Xdata}.
...
decode_pubsub_configure_els(__TopXMLNS, __Opts,
    ...
    case xmpp_codec:get_attr(<<"xmlns">>,
        ...
        of
        <<"jabber:x:data">> ->
            decode_pubsub_configure_els(__TopXMLNS,
                                        __Opts,
                                        _els,
                                        xep0004:decode_xdata(<<"jabber:x:data">>,
                                                             __Opts,
...
decode_pubsub_create(__TopXMLNS, __Opts,
    ...
    Node = decode_pubsub_create_attrs(__TopXMLNS,
                                      _attrs,
                                      undefined),
    Node.
...
encode_pubsub_options({ps_options,
                       Node,
                       Jid,
                       Subid,
                       Xdata},
...
decode_pubsub_publish(__TopXMLNS, __Opts,
    ...
    Items = decode_pubsub_publish_els(__TopXMLNS,
                                      ...
                                      _els,
                                      []),
    Node = decode_pubsub_publish_attrs(__TopXMLNS,
                                       _attrs,
                                       undefined),
...
encode_pubsub_unsubscribe({ps_unsubscribe,
                           Node,
                           Jid,
                           Subid},
                          __TopXMLNS) ->
...
decode_pubsub_item(__TopXMLNS, __Opts,
    ...
    __Els = decode_pubsub_item_els(__TopXMLNS,
                                   __Opts,
                                   _els,
                                   []),
...
encode_pubsub_owner_affiliation({ps_affiliation,
                                 Xmlns,
                                 _,
                                 Type,
                                 Jid},
...
encode_pubsub_affiliation({ps_affiliation,
                           Xmlns,
                           Node,
                           Type,
                           _},
...
encode_pubsub_subscription({ps_subscription,
                            Xmlns,
                            Jid,
                            Type,
                            Node,
